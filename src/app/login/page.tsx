    ...
    return (
        <div className="relative">
            <div className="min-h-screen grid lg:grid-cols-2 relative h-full">
                ...
                <div className="flex flex-col justify-center items-center px-4 py-12 sm:px-8 lg:flex-none lg:px-20 xl:px-24 bg-white/90 dark:bg-slate-950 z-10 relative">
                ...
                <div className="hidden lg:block relative w-full h-full bg-[#3a0ca3]/90 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12 text-center z-10">
                        ...
                        <p className="text-xl text-blue-100/90 font-medium max-w-lg leading-relaxed drop-shadow-md mt-4">
                            Trang quản lý nội bộ Phòng Thử nghiệm theo tiêu chuẩn ISO
                        </p>
            ...
            <div className="fixed inset-0 z-[-10] w-full h-full overflow-hidden bg-blue-500 max-h-screen">
                <Image
                    src="/profile/image/background_MTELAB.png"
                    alt="background_MTELAB"
                    fill
